                ...
                <div className="p-6">
                  ...
                  <div className="relative" style={{ width: "220px", height: "140px", margin: "0 auto" }}>
                    {whySellSlides.map((slide, index) => (
                      <div
                        key={slide.id}
                        className={`absolute top-0 left-0 transition-opacity duration-500 ${activeSlide === index ? "opacity-100 z-10" : "opacity-0 z-0"
                          }`}
                        style={{
                          width: "220px",
                      ...
                      {whySellSlides.map((slide, index) => (
                        <li key={slide.id}>
                          <button
                            ...
                            className={`w-2.5 h-2.5 rounded-full transition-all ${activeSlide === index
